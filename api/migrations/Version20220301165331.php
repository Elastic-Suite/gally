 ...
 */
final class Version20220301165331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE localized_catalog (id INT NOT NULL, catalog_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, code VARCHAR(255) NOT NULL, locale VARCHAR(5) DEFAULT NULL, PRIMARY KEY(id))');
