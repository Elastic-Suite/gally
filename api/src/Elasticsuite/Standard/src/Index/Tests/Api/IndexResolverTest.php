...
class IndexResolverTest extends AbstractTest
{
    ...
    {
        return [
            ['product', 'b2c_fr', 'elasticsuite_b2c_fr_product'],
            ['product', 'b2c_en', 'elasticsuite_b2c_en_product'],
            ['product', 'b2b_en', 'elasticsuite_b2b_en_product'],
            ['category', 'b2c_fr', 'elasticsuite_b2c_fr_category'],
            ['category', 'b2c_en', 'elasticsuite_b2c_en_category'],
            ['category', 'b2b_en', 'elasticsuite_b2b_en_category'],
        ];
    }
}
