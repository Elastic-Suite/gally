...
namespace Gally\VirtualCategory\Tests\Api\Rest;

use Gally\Category\Tests\Api\Rest\CategoryProductMerchandisingTest as BaseCategoryProductMerchandisingTest;
