...
namespace Gally\VirtualCategory\Decoration\Repository\CategoryProductPositionIndexer;

use Elasticsearch\Client;
use Gally\Catalog\Model\LocalizedCatalog;
use Gally\Category\Repository\CategoryConfigurationRepository;
use Gally\Category\Repository\CategoryProductPositionIndexer\CategoryProductPositionIndexerRepository as BaseCategoryProductPositionIndexerRepository;
