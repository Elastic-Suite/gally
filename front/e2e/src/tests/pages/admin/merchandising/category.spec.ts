...
async function changeCatalogDropdown(page: Page, dropdown: Dropdown, value: string, waitForRequest = true): Promise<void> {
...
async function selectCatalog(page: Page, catalog: string, waitForRequest = true): Promise<void> {
  await changeCatalogDropdown(page, getCatalogDropdown(page), catalog, waitForRequest)
}

async function selectLocalizedCatalog(page: Page, localizedCatalog: string, waitForRequest = true): Promise<void> {
  await changeCatalogDropdown(page, getLocalizedCatalogDropdown(page), localizedCatalog, waitForRequest)
}
