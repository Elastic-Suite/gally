...
const existingCatalogs: Record<string, string[]> = {
  'COM': ['French (France)', 'English (United States)'],
  'FR': ['French (France)', 'English (United States)'],
  'UK': ['French (France)', 'English (United States)'],
}

const expectedActiveLocales: string[] = ['French (France)', 'English (United States)']
